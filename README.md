...
- **Stage briefs 1-7** -- design intent and build actuals for each stage ([view folder](https://github.com/jayshreethite2024/menumate-ai-menu-assistant/blob/main/docs/stage-briefs/))
- **Eval Run 2 report** -- 13 retested cases, root cause analysis, fixes applied ([download](https://github.com/jayshreethite2024/menumate-ai-menu-assistant/raw/main/docs/eval-reports/menumate_eval_run2_report.docx))
- **Eval Run 3 report** -- 35/35 pass, synthesis funnel per round ([download](https://github.com/jayshreethite2024/menumate-ai-menu-assistant/raw/main/docs/eval-reports/menumate_eval_run3_report.docx))
- **System prompt (final)** -- complete system prompt as deployed in the chat Edge Function ([view](https://github.com/jayshreethite2024/menumate-ai-menu-assistant/blob/main/docs/system-prompt/menumate_system_prompt.md))
- **Full case study** -- opportunity validation through launch, PM decisions, learnings ([download](https://github.com/jayshreethite2024/menumate-ai-menu-assistant/raw/main/docs/case-study/menumate_casestudy.docx))
- **PRD + Execution Playbook** -- Part A (PRD) and Part B (Execution OS) for MenuMate ([download](https://github.com/jayshreethite2024/menumate-ai-menu-assistant/raw/main/docs/case-study/menumate_prd.docx))
...
**Jayshree Thite**
Senior Consultant at Deloitte -- PM transition portfolio

jayshreethite2024@gmail.com | [LinkedIn](https://www.linkedin.com/in/jayshreethite2024)
